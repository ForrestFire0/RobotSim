...
import sample.Emulator.ControlMode;
import sample.Emulator.FeedbackDevice;
...
public class MechDrive {
    ...
    private MyTalonSRX backLeft;
    private MyTalonSRX backRight;
    ...
    public MechDrive(NavX navX) {
        ...
        frontLeft = new MyTalonSRX(1);
        frontRight = new MyTalonSRX(2);
        backLeft = new MyTalonSRX(3);
        backRight = new MyTalonSRX(4);
